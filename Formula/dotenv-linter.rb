class DotenvLinter < Formula
  ...
  if OS.mac?
    url "https://github.com/mgrachev/dotenv-linter/releases/download/v1.2.0/dotenv-linter-darwin-x86_64.tar.gz"
    sha256 "77bb9375af19a8b0acd1423bc920801add772c874661ebd41530f50d45f61fae"
  elsif OS.linux?
    url "https://github.com/mgrachev/dotenv-linter/releases/download/v1.2.0/dotenv-linter-linux-x86_64.tar.gz"
